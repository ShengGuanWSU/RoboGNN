...
from dataset_process import utils
...
class GCN(nn.Module):
    ...
    ###update the forward function that considers ppr


    def forward(self, x, adj,ppr):
        if self.with_relu:
        ...
        #print(diffused_logits.shape)

        return F.log_softmax(x, dim=1), logits, diffused_logits
